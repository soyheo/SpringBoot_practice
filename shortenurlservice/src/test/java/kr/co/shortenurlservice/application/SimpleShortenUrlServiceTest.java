...
public class SimpleShortenUrlServiceTest {
    ...
    @Test
    @DisplayName("존재하지 않는 단축 URL로 조회하면 NotFoundShortenUrlException이 발생해야한다.")
    void findShortenUrlNotExistTest() {
        String notExistShortenUrl = "https://www.google.com";

        assertThrows(NotFoundShortenUrlException.class, () -> {
            simpleShortenUrlService.getOriginalUrlByShortenUrlKey(notExistShortenUrl);
        });
    }
}
